...
router.get('/topics', lessonController.getLessonTopics)
...
router.get('/:id/progress/:targetUserId', auth, requireModeratorOrAdmin, lessonController.getLessonProgressForUser)
...
router.post('/:id/sync-scores', auth, requireModeratorOrAdmin, lessonController.syncLessonQuizScores)
